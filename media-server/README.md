...
```bash
./mvnw clean && rsync -r . th0r5ti@pohl.rocks:/home/th0r5ti/software/flights-media-server
```
...
You can then execute your native executable with: `./target/media-server-1.0.0-SNAPSHOT-runner`
